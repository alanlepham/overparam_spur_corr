...
def resnet10vw(width, pretrained=False, progress=True, **kwargs):
    ...
    """
    return _vwresnet(
        "resnet10", BasicBlock, [1, 1, 1, 1], width, pretrained, progress, **kwargs
    )
...
def resnet18vw(width, pretrained=False, progress=True, **kwargs):
    ...
    """
    return _vwresnet(
        "resnet18", BasicBlock, [2, 2, 2, 2], width, pretrained, progress, **kwargs
    )
...
def resnet34vw(width, pretrained=False, progress=True, **kwargs):
    ...
    """
    return _vwresnet(
        "resnet34", BasicBlock, [3, 4, 6, 3], width, pretrained, progress, **kwargs
    )
...
def resnet50vw(width, pretrained=False, progress=True, **kwargs):
    ...
    """
    return _vwresnet(
        "resnet50", Bottleneck, [3, 4, 6, 3], width, pretrained, progress, **kwargs
    )
