...
def generate_toy_data_random_projections(
    n,
    d_causal,
    d_spurious,
    p_correlation,
    ...
    for group_idx, (y_value, a_value) in enumerate(groups):
        ...
        x_causal_list.append(
            np.random.multivariate_normal(
                mean=y_value * np.ones(d_causal) * mean_causal,
        ...
        x_spurious_list.append(
            np.random.multivariate_normal(
                mean=a_value * np.ones(d_spurious) * mean_spurious,
...
def generate_toy_data_no_projections(
    n,
    d_noise,
    p_correlation,
    mean_causal,
