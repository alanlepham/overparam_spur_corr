...
python3 run_expt.py --shift_type confounder --dataset Breeds --train_from_scratch --lr .1 --target_name breeds --save_step 50 --n_epochs 300 --batch_size 128 --weight_decay 1.00E-04 --model resnet18 --subsample_to_minority --log_dir ./log/basic_breeds